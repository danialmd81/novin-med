...
Medical device application for the CPM (Continuous Passive Motion) device, Android variant, running on Raspberry Pi.
...
- Designed for CPM Android medical hardware.
