...
Medical device application for the Adina device, running on Raspberry Pi.
...
- Set `DEFINES += RASPBERRY_7INCH` or `RASPBERRY_10INCH` in `.pro` as needed.

## Notes / Limitations

- Designed for Adina medical hardware.
