...
```sh
wget https://raw.githubusercontent.com/Kukkimonsuta/buildqt/master/scripts/utils/sysroot-relativelinks.py
...
```sh
./configure -release -opengl es2 -device <version> \
...
[qt-everywhere-src-6.10.3.tar.xz](https://download.qt.io/archive/qt/6.10/6.10.3/single/qt-everywhere-src-6.10.3.tar.xz)
