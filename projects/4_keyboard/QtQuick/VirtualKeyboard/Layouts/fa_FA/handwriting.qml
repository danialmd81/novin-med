...
KeyboardLayout {
    ...
    KeyboardRow {
        KeyboardColumn {
            ...
            InputModeKey {
                inputModeNameList: ["ABC"  // InputEngine.InputMode.Latin
        ...
        KeyboardColumn {
            ...
            TraceInputKey {
                ...
                horizontalRulers: alphabeticInputMode ? [] : [Math.round(boundingBox.height / 4), Math.round(boundingBox.height / 4) * 2, Math.round(boundingBox.height / 4) * 3]
            }
        }
        KeyboardColumn {
            Layout.preferredWidth: 1
