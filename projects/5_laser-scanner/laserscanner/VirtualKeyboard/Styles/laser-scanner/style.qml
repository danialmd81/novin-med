...
KeyboardStyle {
    ...
    readonly property string resourcePrefix: "/QtQuick/VirtualKeyboard/Styles/laser-scanner/"

    readonly property string inputLocale: InputContext.locale
    property color primaryColor: "#E9EAEE"
    property color primaryLightColor: "#CBCED5"
    property color primaryDarkColor: '#ffffff'
    property color textOnPrimaryColor: '#000000'
    property color smallTextOnPrimaryColor: '#4C4C4C'
    property color secondaryColor: "#01579b"
    property color secondaryLightColor: "#4f83cc"
    property color secondaryDarkColor: "#002f6c"
    property color textOnSecondaryColor: '#000000'
    ...
    property color keySmallTextColor: smallTextOnPrimaryColor
    ...
    keyboardDesignWidth: 1062 * 1.5
    keyboardDesignHeight: 549 * 1.5
    ...
    keyPanel: KeyPanel {
        ...
        Rectangle {
            id: keyBackground
            radius: 12
            color: control && control.highlighted ? normalKeyBackgroundColor : normalKeyBackgroundColor
            ...
            Text {
                ...
                anchors.rightMargin: keyContentMargin / 3
    ...
    backspaceKeyPanel: KeyPanel {
        ...
        Rectangle {
            ...
            Image {
                ...
                smooth: false
                source: resourcePrefix + "images/backspace-000.svg"
            }
        }
        states: [
            State {
    ...
    languageKeyPanel: KeyPanel {
        ...
        Rectangle {
            ...
            Image {
                ...
                smooth: false
                source: resourcePrefix + "images/globe-000.svg"
            }
        }
        states: [
            State {
    ...
    shiftKeyPanel: KeyPanel {
        ...
        Rectangle {
            ...
            Image {
                ...
                smooth: false
                source: resourcePrefix + "images/shift-000.svg"
            }
            states: [
                State {
                    name: "capsLockActive"
